...
export const DEFAULT_TEMPLATES: { name: string; variables: FormulaVariable[] }[] = [
    {
        ...
        variables: [
            ...
            { id: '3', name: 'RA', expression: '75', unit: 'ml', description: 'อัตราการพ่นต่อ 1000 ตร.ม.' },
            { id: '4', name: 'tank', expression: '10', unit: 'L', description: 'ขนาดถังพ่น (ตัวทำละลาย)' },
            { id: '5', name: 'area_per_tank', expression: '(tank * 1000) / (RA / 1000)', unit: 'ตร.ม.', description: 'พื้นที่ที่พ่นได้ต่อถัง' },
            { id: '6', name: 'chemical_per_tank', expression: 'tank * 1000 * C / S', unit: 'ml', description: 'ปริมาณสารเคมีต่อถัง (มล.)' },
            { id: '7', name: 'solvent_per_tank', expression: 'tank * 1000', unit: 'ml', description: 'ปริมาณตัวทำละลายต่อถัง (มล.)' },
            { id: '8', name: 'total_per_tank', expression: 'chemical_per_tank + solvent_per_tank', unit: 'ml', description: 'ปริมาณรวมต่อถัง (มล.)' },
        ],
    },
    {
        ...
        variables: [
            ...
            { id: '4', name: 'RA', expression: '1', unit: 'L', description: 'อัตราพ่นต่อ 1000 ตร.ม.' },
            { id: '5', name: 'tank', expression: '10', unit: 'L', description: 'ขนาดถังพ่น' },
            { id: '6', name: 'chemical_per_tank', expression: 'tank * C / ratio_total', unit: 'L', description: 'ปริมาณสารเคมีต่อถัง' },
            { id: '7', name: 'chemical_per_tank_ml', expression: 'chemical_per_tank * 1000', unit: 'ml', description: 'ปริมาณสารเคมีต่อถัง (มล.)' },
            { id: '8', name: 'solvent_per_tank', expression: 'tank - chemical_per_tank', unit: 'L', description: 'ปริมาณตัวทำละลายต่อถัง' },
            { id: '9', name: 'area_per_tank', expression: 'tank * 1000 / RA', unit: 'ตร.ม.', description: 'พื้นที่พ่นต่อถัง' },
            { id: '10', name: 'houses_per_tank', expression: 'area_per_tank / 100', unit: 'หลัง', description: 'จำนวนบ้านต่อถัง (บ้านละ 100 ตร.ม.)' },
        ],
    },
    {
